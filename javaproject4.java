...
public class Employee {
    ...
    class Emp{
        public static void main(String[] args){
            Employee e1 = new Employee("Robert", 1994, 48000, "64C- WallsStreet");
            Employee e2 = new Employee("Sam", 2000, 69000, "68D- WallsStreet");
            Employee e3 = new Employee("John", 1999, 100000, "26B- WallsStreet");
            System.out.println("Name\t Year of Joining\tSallary\t\t Address");
